...
// Mutations
export const MUTATE_INCREMENT_COUNTER = 'counter/INCREMENT_COUNTER'
export const MUTATE_DECREMENT_COUNTER = 'counter/DECREMENT_COUNTER'
export const MUTATE_UPDATE_VALUE = 'shared/UPDATE_VALUE'
